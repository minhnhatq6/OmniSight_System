        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FaceVector = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    FaceImageUrl = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClassMembers", x => new { x.ClassId, x.StudentId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Streams", x => x.PostId);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Streams_Users_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "Users",
                        principalColumn: "UserId");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignmentId = table.Column<int>(type: "int", nullable: false),
                    StudentId = table.Column<int>(type: "int", nullable: false),
                    FileOrLinkUrl = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExamResultResultId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ViolationLogs", x => x.LogId);
                    table.ForeignKey(
                        name: "FK_ViolationLogs_ExamResults_ExamResultResultId",
                        column: x => x.ExamResultResultId,
                        principalTable: "ExamResults",
                        principalColumn: "ResultId");
                    table.ForeignKey(
                        name: "FK_ViolationLogs_ExamResults_ResultId",
                        column: x => x.ResultId,
                        principalTable: "ExamResults",
                        principalColumn: "ResultId");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ViolationLogs_ExamResultResultId",
                table: "ViolationLogs",
                column: "ExamResultResultId");

            migrationBuilder.CreateIndex(
                name: "IX_ViolationLogs_ResultId",
                table: "ViolationLogs",
                column: "ResultId");
        }
